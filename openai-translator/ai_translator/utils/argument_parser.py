...
class ArgumentParser:
    def __init__(self):
        ...
        self.parser.add_argument('--source_language', type=str, default='English', help='The language of the original book to be translated.')
        self.parser.add_argument('--target_language', type=str, default='Chinese', help='The target language for translating the original book.')

    def parse_arguments(self):
        args = self.parser.parse_args()
        if args.model_type == 'OpenAIModel' and not args.openai_model and (not args.openai_api_key or not os.getenv("OPENAI_API_KEY")):
